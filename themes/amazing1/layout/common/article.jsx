...
module.exports = class extends Component {
    render() {
        ...
        const { article, plugins, comment, has_latest_modify_time, has_copyright, busuanzi_only_count, index_show_tags_cateories,index_adsense_positions } = config;
        ...
        return <Fragment>
            {/* Main content */}
            {indexAt != undefined & indexAt == 0 ? <AdsenseX /> : null}
            {!index ? <AdsenseX /> : null}
            <div class="card">
                {/* Thumbnail */}
